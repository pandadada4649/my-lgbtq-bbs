...
CATEGORIES = [
    {'id': 'Lesbian',    'ja': 'レズビアン',       'color': '#e84393', 'bg': '#fce7f3',
     'svg': '<svg viewBox="0 0 28 28" width="28" height="28" fill="none"><path d="M14 22C14 22 5 15.5 5 9.5C5 6.46 7.46 4 10.5 4C12.24 4 13.8 4.9 14 6C14.2 4.9 15.76 4 17.5 4C20.54 4 23 6.46 23 9.5C23 15.5 14 22 14 22Z" fill="#f472b6" fill-opacity=".85"/></svg>'},
    {'id': 'Gay',        'ja': 'ゲイ',             'color': '#f97316', 'bg': '#fff7ed',
     'svg': '<svg viewBox="0 0 28 28" width="28" height="28" fill="none"><circle cx="14" cy="14" r="6" fill="#fbbf24" fill-opacity=".9"/><circle cx="14" cy="14" r="9" stroke="#f97316" stroke-width="1.5" stroke-dasharray="3 2"/><line x1="14" y1="3" x2="14" y2="6" stroke="#f97316" stroke-width="2" stroke-linecap="round"/><line x1="14" y1="22" x2="14" y2="25" stroke="#f97316" stroke-width="2" stroke-linecap="round"/><line x1="3" y1="14" x2="6" y2="14" stroke="#f97316" stroke-width="2" stroke-linecap="round"/><line x1="22" y1="14" x2="25" y2="14" stroke="#f97316" stroke-width="2" stroke-linecap="round"/></svg>'},
    {'id': 'Bisexual',   'ja': 'バイセクシュアル',  'color': '#a855f7', 'bg': '#faf5ff',
     'svg': '<svg viewBox="0 0 28 28" width="28" height="28" fill="none"><path d="M14 4L14 24M14 4C14 4 8 7 8 14C8 21 14 24 14 24C14 24 20 21 20 14C20 7 14 4 14 4Z" fill="#c084fc" fill-opacity=".5" stroke="#a855f7" stroke-width="1.5"/></svg>'},
    {'id': 'Transgender','ja': 'トランスジェンダー','color': '#3b82f6', 'bg': '#eff6ff',
     'svg': '<svg viewBox="0 0 28 28" width="28" height="28" fill="none"><path d="M14 5L16 9H22L17 12.5L19 17L14 13.5L9 17L11 12.5L6 9H12L14 5Z" fill="#93c5fd" fill-opacity=".8" stroke="#3b82f6" stroke-width="1.2" stroke-linejoin="round"/><path d="M14 18V23" stroke="#3b82f6" stroke-width="2" stroke-linecap="round"/><path d="M11 23H17" stroke="#f9a8d4" stroke-width="2" stroke-linecap="round"/></svg>'},
    {'id': 'Queer',      'ja': 'クィア',           'color': '#22c55e', 'bg': '#f0fdf4',
     'svg': '<svg viewBox="0 0 28 28" width="28" height="28" fill="none"><path d="M14 4C10 4 7 7.5 7 11.5C7 17 11 20 14 23C17 20 21 17 21 11.5C21 7.5 18 4 14 4Z" fill="#86efac" fill-opacity=".7" stroke="#22c55e" stroke-width="1.5"/><path d="M10 12C10 12 11.5 15 14 15C16.5 15 18 12 18 12" stroke="#16a34a" stroke-width="1.5" stroke-linecap="round"/></svg>'},
    {'id': 'Ally',       'ja': 'アライ',           'color': '#eab308', 'bg': '#fefce8',
     'svg': '<svg viewBox="0 0 28 28" width="28" height="28" fill="none"><path d="M14 4L16.5 10.5H23.5L18 14.5L20 21L14 17L8 21L10 14.5L4.5 10.5H11.5L14 4Z" fill="#fde68a" stroke="#f59e0b" stroke-width="1.5" stroke-linejoin="round"/></svg>'},
    {'id': 'All / Mix',  'ja': '誰でもOK',         'color': '#7c3aed', 'bg': '#f5f3ff',
     'svg': '<svg viewBox="0 0 28 28" width="28" height="28" fill="none"><path d="M14 22C14 22 5 15.5 5 9.5C5 6.46 7.46 4 10.5 4C12.24 4 13.8 4.9 14 6C14.2 4.9 15.76 4 17.5 4C20.54 4 23 6.46 23 9.5C23 15.5 14 22 14 22Z" fill="#ddd6fe" fill-opacity=".8" stroke="#7c3aed" stroke-width="1.5"/></svg>'},
]
